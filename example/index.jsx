...
import Canvas from 'otk-react-fabricjs/Canvas';
import Circle from 'otk-react-fabricjs/shape/Circle';
import Path from 'otk-react-fabricjs/shape/Path';
// import PathGroup from 'react-fabricjs/shape/PathGroup';
import Image from 'otk-react-fabricjs/Image';
import Text from 'otk-react-fabricjs/Text';
import IText from 'otk-react-fabricjs/IText';
...
class Example extends React.Component {
	...
	addNew() {
		...
		this.setState({
			newObject: [
				<Image key="big" src="http://i.imgur.com/jZsNUCi.jpg" width={300} height={300} left={0} top={500} />,
				<Image key="small" src="http://i.imgur.com/jZsNUCi.jpg" width={250} height={250} left={200} top={300} />
			]
		});
	}
		...
		return (
			<div className="main-container">
				<Canvas ref="canvas" width="1000" height="1000">
					<Circle ref="circle" radius={20} fill={this.state.color} left={100} top={50} stroke="green" />

					<Image ref="image" imgElement={document.getElementById('my-image')} width={100} height={100} />

					{this.state.newObject}

					<Path path="M 0 0 L 300 100 L 200 300 z" fill="red" stroke="green" strokeWidth={10} opacity={0.5} />
