...
export default class Path extends FabricObject {
	constructor(props, context) {
		...
		this.toDatalessObject = propertiesToInclude => this.state.object.toDatalessObject(propertiesToInclude);
	...
	draw(cb) {
		if (this.props.element instanceof Object) {
			fabric.Path.fromElement(this.props.element, instance => super.draw(instance, cb), this.props);
		} else if (this.props.object instanceof Object) {
			fabric.Path.fromObject(this.props.object, instance => super.draw(instance, cb));
		} else {
