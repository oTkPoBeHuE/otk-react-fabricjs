...
export default class Circle extends FabricObject {
	constructor(props, context) {
		...
		this.getRadiusX = () => this.state.object && this.state.object.getRadiusX();
		this.getRadiusY = () => this.state.object && this.state.object.getRadiusY();
		this.setRadius = value => this.state.object && this.state.object.setRadius(value);
