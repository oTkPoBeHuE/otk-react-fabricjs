...
export default class Ellipse extends FabricObject {
	constructor(props, context) {
		...
		this.getRx = () => this.state.object && this.state.object.getRx();
		this.getRy = () => this.state.object && this.state.object.getRy();
		this.toObject = propertiesToInclude => this.state.object && this.state.object.toObject(propertiesToInclude);
		this.toSVG = reviver => this.state.object && this.state.object.toObject(reviver);
